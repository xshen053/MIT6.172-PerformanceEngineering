...
.LBB1_2:                                #   Parent Loop BB1_1 Depth=1
	...
	movq	8224(%rsp,%rax,8), %rcx
	movq	8232(%rsp,%rax,8), %rdx
	addq	16416(%rsp,%rax,8), %rcx
	addq	16424(%rsp,%rax,8), %rdx
	movq	%rcx, 32(%rsp,%rax,8)
	movq	8240(%rsp,%rax,8), %rcx
	addq	16432(%rsp,%rax,8), %rcx
	movq	%rdx, 40(%rsp,%rax,8)
	movq	8248(%rsp,%rax,8), %rdx
	addq	16440(%rsp,%rax,8), %rdx
	movq	%rcx, 48(%rsp,%rax,8)
