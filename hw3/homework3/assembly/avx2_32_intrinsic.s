...
.LBB1_2:                                #   Parent Loop BB1_1 Depth=1
	...
	vmovdqa	4128(%rsp,%rax,4), %ymm0
	vmovdqa	4160(%rsp,%rax,4), %ymm1
	vmovdqa	4192(%rsp,%rax,4), %ymm2
	vmovdqa	4224(%rsp,%rax,4), %ymm3
	...
	vmovdqa	%ymm0, 32(%rsp,%rax,4)
	vmovdqa	%ymm1, 64(%rsp,%rax,4)
	vmovdqa	%ymm2, 96(%rsp,%rax,4)
	vmovdqa	%ymm3, 128(%rsp,%rax,4)
	addq	$32, %rax
