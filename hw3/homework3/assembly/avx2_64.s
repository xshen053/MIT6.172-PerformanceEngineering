...
# %bb.0:
	...
	subq	$24616, %rsp                    # imm = 0x6028
	.cfi_def_cfa_offset 24656
	.cfi_offset %rbx, -40
	.cfi_offset %r12, -32
	.cfi_offset %r14, -24
	.cfi_offset %r15, -16
...
.LBB1_2:                                #   Parent Loop BB1_1 Depth=1
	...
	vmovdqu	8224(%rsp,%rax,8), %ymm0
	vmovdqu	8256(%rsp,%rax,8), %ymm1
	vmovdqu	8288(%rsp,%rax,8), %ymm2
	vmovdqu	8320(%rsp,%rax,8), %ymm3
	vpaddq	16416(%rsp,%rax,8), %ymm0, %ymm0
	vpaddq	16448(%rsp,%rax,8), %ymm1, %ymm1
	vpaddq	16480(%rsp,%rax,8), %ymm2, %ymm2
	vpaddq	16512(%rsp,%rax,8), %ymm3, %ymm3
	vmovdqu	%ymm0, 32(%rsp,%rax,8)
	vmovdqu	%ymm1, 64(%rsp,%rax,8)
	vmovdqu	%ymm2, 96(%rsp,%rax,8)
	vmovdqu	%ymm3, 128(%rsp,%rax,8)
	addq	$16, %rax
